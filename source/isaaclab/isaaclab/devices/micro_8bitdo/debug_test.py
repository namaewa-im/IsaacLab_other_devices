...
def main():
    print("=" * 60)
    print("디버그: 8BitDo 컨트롤러 테스트 시작")
    print("=" * 60)
    print(f"Python 버전: {sys.version}")
    print(f"Python 경로: {sys.executable}")
    
    # 파일에 로그 기록
    with open("/tmp/isaaclab_debug.log", "w") as f:
        f.write("IsaacLab 디버그 로그 시작\n")
        ...
        try:
            ...
            f.write("✓ omni.appwindow 모듈 로드됨\n")
            f.flush()
            print("✓ omni.appwindow 모듈 로드됨")
    ...
    print("\n테스트 완료")
    print("로그 파일: /tmp/isaaclab_debug.log")
